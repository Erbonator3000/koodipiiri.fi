...
paremmin kuvaa sen käyttöä, tässä tapauksessa `ledPin`. Kerromme ohjelmalle myös, että numero, 
jonka annamme `ledPin`-muuttujalle, on kokonaisluku eli `int` (englanniksi *integer*). Viimeseksi 
lisäämme kommentin, joka kuvaa mitä ohjelmamme tämä rivi tekee (harmaa teksti kahden kenoviivan 
jälkeen). Kommentteja ei huomioida ohjelmassa, ja ne ovat ainoastaan ohjelmoijan omaksi avuksi. 
...
päältä (eli 0 V tai `LOW`-tila). Jotta LEDi pysyy samassa tilassa tietyn aikaa, käytämme 
...
Kun olet kirjoittanut yllä olevan ohjelman valmiiksi, napsauta Tarkista-painiketta ja korjaa 
mahdolliset virheet. Tämän jälkeen olet valmis lataamaan ohjelmasi Lähetä-painikkeella. 
Jos LED-valo vilkkuu, onnea! Olet juuri kirjoittanut ensimmäisen Arduino-ohjelmasi.