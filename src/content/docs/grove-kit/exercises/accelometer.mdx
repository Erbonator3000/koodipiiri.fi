...
Tässä tehtävässä opit lukemaan tietoja kolmen akselin kiihtyvyysanturista ja piirtämään niitä 
...
sarjanäytön käyttäminen kuten ennenkin. Toinen on *Serial Plotter*, johon pääset kohdasta 
Työkalut > Sarjapiirturi. Piirturi on erittäin hyödyllinen työkalu, joka piirtää tiedot 
meille kaaviomuodossa. Kokeile kallistaa ja kääntää lautaasi tunnistaaksesi kiihtyvyysanturin 
